...
private final class LegacyDataImportSplashImpl: WindowCoveringView, LegacyDataImportSplash {
    ...
    public var progress: (AccountImportProgressType, Float) = (.generic, 0.0) {
        didSet {
            ...
            self.progressNode.transitionToState(.progress(color: self.theme?.list.itemAccentColor ?? UIColor(rgb: 0x191970), lineWidth: 2.0, value: CGFloat(max(0.025, self.progress.1)), cancelEnabled: false, animateRotation: true), animated: false, completion: {})
        }
    }
